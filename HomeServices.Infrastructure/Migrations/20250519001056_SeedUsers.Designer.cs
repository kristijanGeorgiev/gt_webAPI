...
namespace HomeServices.Infrastructure.Migrations
{
    ...
    [Migration("20250519001056_SeedUsers")]
            ...
            modelBuilder.Entity("HomeServices.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Address = "Main Office",
                            CreatedAt = new DateTime(2025, 5, 19, 0, 10, 55, 227, DateTimeKind.Utc).AddTicks(1170),
                            ...
                            Role = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 19, 0, 10, 55, 227, DateTimeKind.Utc).AddTicks(1397),
                            Username = "admin"
                        });
                });
